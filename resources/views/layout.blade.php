...
<footer class="section footer-classic footer-classic-md">
                ...
                <div class="footer-classic-layout-item">
                    ...
                    <div class="footer-classic-item-block">
                        ...
                        <ul class="list-inline list-inline-md">
                            <li><a class="link-2" href="#"><i class="fa-instagram"></i></a></li>
    ...
    <div class="footer-classic-aside">
        <div class="container">
            <p class="rights"><span>&copy;&nbsp; </span><span class="copyright-year"></span><span>&nbsp;</span><span>SunEng</span><span>. All rights reserved.</span></p>
        </div>
    </div>
</footer>
</body>
